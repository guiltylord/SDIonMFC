...
// Foo.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CFooApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CFooApp::OnAppAbout)
...
CFooApp::CFooApp() noexcept
{
	...
	SetAppID(_T("Foo.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CFooApp

CFooApp theApp;


// Инициализация CFooApp
